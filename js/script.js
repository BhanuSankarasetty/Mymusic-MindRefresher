...
async function displayAlbums() {
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs/") && !e.href.includes(".htaccess")) {
            let folder = decodeURIComponent(e.href.split("/songs/")[1]);
            ...
            try {
                ...
                console.warn(`Skipping folder /songs/${folder}/:`, err);
            }
        }
    }
...
async function main() {
    ...
    // ✅ Start with first available album (e.g. "love") instead of non-existent "ncs"
